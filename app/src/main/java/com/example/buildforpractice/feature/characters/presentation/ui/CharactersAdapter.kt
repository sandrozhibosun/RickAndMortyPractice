...
class CharactersAdapter @Inject constructor(
    ...
    RecyclerView.Adapter<CharactersAdapter.CharactersItemViewHolder>() {
    ...
    fun setCharactersList(
        mCharactersList: List<RMCharacter>,
    ) {
    ...
    override fun onBindViewHolder(holder: CharactersItemViewHolder, position: Int) {
        holder.bind(mCharactersList[position], onItemClick)
    }
